...
import com.taoguba.app.TimeIntervalDialog.TimeIntervalInterface;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// MiPushClient.setAlias(MainActivity.this, "a0000055cc71fe6114", null);
		 MiPushClient.setAlias(MainActivity.this, "00000000-7deb-db10-0000-00007e1e58a9", null);
		// 设置别名
		findViewById(R.id.set_alias).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.set_alias).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.unset_alias).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unset_alias).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.set_account).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.set_account).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.unset_account).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unset_account).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.subscribe_topic).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.subscribe_topic).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
		...
		findViewById(R.id.unsubscribe_topic).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				final EditText editText = new EditText(MainActivity.this);
				new AlertDialog.Builder(MainActivity.this).setTitle(R.string.unsubscribe_topic).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
